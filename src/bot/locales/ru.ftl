...
subscription-invoice-created = <b>🔒 Доступ к закрытому сообществу "{$title}"</b>
    ...
    *[other] доступ на месяц
    ...
    <i>Счёт действителен 48 часов. Чтобы запросить новый счёт, отправь повторную заявку на вступление в чат.</i>