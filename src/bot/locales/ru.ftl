...
subscription-invoice = 
    .created = <b>🔒 Доступ к закрытому сообществу "{$title}"</b>
    ...
    *[other] доступ на месяц
    ...
    {$type ->
    [one_time] <i></i>
    *[other] <i>Сумма подписки будет автоматически списываться с твоих кошельков в {bot-name} каждый месяц.</i>
