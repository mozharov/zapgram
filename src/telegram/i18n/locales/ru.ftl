...
settings = <b>⚙️ NWC</b>
    ...
    .groups = <b>👥 Чаты</b>
        ...
        <b>Платный доступ</b> настраивается отдельно: сделай бота админом с правами приглашать и банить, затем открой <b>Платные чаты</b> ниже. Одно только добавление бота платный доступ не включает.
...
chat = <b>👥 {$title}</b>
    ...
    *[other] выключена
    ...
    <i>Чтобы платный доступ работал, в чате должны быть включены <b>заявки на вступление</b> (одобрение новых участников / invite-ссылка с запросом на вступление) — тогда бот сможет отправить инвойс вступившему и принять его после оплаты.</i>
