...
start = ⚡ <b>{bot-name} — Bitcoin Lightning кошелёк в Telegram.</b>
    Отправляй и получай сатоши в чатах и настраивай платный доступ к группам и каналам.

    <b>Как работает кошелёк</b>
    {bot-name} создаёт для тебя внутренний кошелёк. Переводы между пользователями Telegram мгновенные, комиссия — 0. Можно подключить свой Lightning-кошелёк через NWC — сатоши останутся под твоим контролем.

    💚 Отдельно по умолчанию включён добровольный донат 5% в поддержку бота при отправке tips. Изменить или отключить: /donate.

    🤝 При поддержке сообщества <a href="https://t.me/bitcoin21ideas">21 идея</a>.
...
help = <b>ℹ️ Bitcoin</b>
    ...
    <b>ℹ️ Кошельки в {bot-name}</b>
    • Внутренний кошелёк: кастодиальное хранение на серверах {bot-name}; переводы внутри Telegram мгновенные и бесплатные.
    • Внешний кошелёк: подключи свой Lightning-кошелёк через NWC. Сатоши остаются под твоим контролем, а {bot-name} действует в рамках заданных тобой лимитов.
    ...
    • Группы и каналы: добавь {bot-username}, чтобы участники могли отправлять tips.
    ...
    • Добровольная поддержка: у новых аккаунтов по умолчанию включён вклад 5% только с tips. Оплата счетов не входит. Изменить или отключить: /donate; внешний адрес: <code>zapgram@getalby.com</code>.
